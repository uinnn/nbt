package harmony.nbt.arrays

import harmony.nbt.*
import harmony.nbt.primitives.*
...
value class PackedBooleanArrayTag(val value: BooleanArray) : IterableTag, BooleanIterable {
   ...
   */
  override fun copy() = harmony.nbt.arrays.BooleanArrayTag(value.copyOf())
  ...
  object Type : TagType<BooleanArrayTag>() {
     ...
     */
    override fun load(data: DataInput): harmony.nbt.arrays.BooleanArrayTag {
      return harmony.nbt.arrays.BooleanArrayTag(data.readBytes().toPackedBooleanArray())
    }
  }
  ...
  companion object {
     ...
     */
    val EMPTY = harmony.nbt.arrays.BooleanArrayTag(BooleanArrays.EMPTY_ARRAY)
  }
}
 ...
 */
fun BooleanArray.toPackedTag() = harmony.nbt.arrays.BooleanArrayTag(this)
